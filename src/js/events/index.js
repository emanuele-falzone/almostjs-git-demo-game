...
exports.createEvents = function (options) {
    return {
        ...
        //comment-to-help-git
        'event-load-settings-done': require('./event-load-settings-done').createEvent(options),
        //comment-to-help-git
        ...
        //comment-to-help-git
        'event-save-settings': require('./event-save-settings').createEvent(options),
        //comment-to-help-git
        'event-save-settings-done': require('./event-save-settings-done').createEvent(options),
        //comment-to-help-git
        'event-settings': require('./event-settings').createEvent(options),
        //comment-to-help-git

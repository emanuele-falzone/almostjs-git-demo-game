...
function ViewModel(params) {
    ...
    self.select = function () {
        ...
        self.output = this;
        self.trigger.call(this, 'selected-answer-qr');
    };
...
ViewModel.prototype.id = 'list-answers-qr';
...
ViewModel.prototype._allComputed = function () {
    if (!this.context.vms['details-question-qr'] || this.context.vms['details-question-qr'].status() !== 'computed') {
        return false;
    }
    return true;
};
...
ViewModel.prototype._firstNotReady = function () {
    if (!this.context.vms['details-question-qr']) {
        return Promise.reject();
    }
    if (this.context.vms['details-question-qr'].status() !== 'computed') {
        return this.context.vms['details-question-qr'].waitForStatusChange();
    }
...
ViewModel.prototype._propagate = function () {
    ...
    this._propagating = this._waitForDependencies().then(function () {
        self.filters['question'] = self.filters['question'] || (
            self.context.vms['details-question-qr'].output &&
            self.context.vms['details-question-qr'].output['id']
        );
        self.status('ready');
...
exports.register = function () {
    ko.components.register('c-list-answers-qr', {
        viewModel: {
